...
start = time.time()
print(f'Result Python FOR: {mass_sort_FOR_cycle.sum_of_two_min_elements(digi_list)}')
end = time.time()
cy_time = end - start

start2 = time.time()
print(f'Result Python MIN: {mass_sort_MIN_function.sum_of_two_min_elements(digi_list)}')
end2 = time.time()
